...
class User(Base):
    ...
    followers = relationship("Follower", back_populates="follower", foreign_keys="Follower.follower_id")
    following = relationship("Follower", back_populates="followed_user", foreign_keys="Follower.followed_user_id")
...
class Follower(Base):
    ...
    followed_user = relationship("User", foreign_keys=[followed_user_id], back_populates="following")
